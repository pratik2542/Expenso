        ...
        <Transition.Root show={open} as={Fragment}>
            <Dialog as="div" className="relative z-50" onClose={onClose}>
                ...
                <div className="fixed inset-0 z-10 overflow-y-auto">
                    <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0" style={{ paddingBottom: 'max(calc(1rem + env(safe-area-inset-bottom, 0px)), 1rem)' }}>
                        <Transition.Child
                            as={Fragment}
                            enter="ease-out duration-300"
